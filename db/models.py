...
# 仓库表
class Repertory(BASE, ScoreBase):
    """Represents a repertory
    """
...
# 申请表
class Application(BASE, ScoreBase):
    """Represents a application
    """
    __tablename__ = 'application'
    id = Column(String(length=128), nullable=False, default=uuid.uuid1, primary_key=True)
    apply_user = Column(String(length=255), nullable=False)
    apply_goods = Column(String(length=255), nullable=False)
    apply_count = Column(Integer, nullable=False, default=0)
    approval = Column(Integer, nullable=False, default=0)
    decline = Column(Integer, nullable=False, default=0)
