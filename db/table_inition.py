...
engine = create_engine('mysql://root:py6996576@127.0.0.1:3306/repertory_sys?charset=utf8', echo=False)
...
repertory_table = Table('repertory', metadata,
                        Column('id', String(128), primary_key=True),
...
table_list.append(repertory_table)


application_table = Table('application', metadata,
                          Column('id', String(128), primary_key=True),
                          Column('apply_user', String(255), nullable=False),
                          Column('apply_goods', String(255), nullable=False),
                          Column('apply_count', Integer, nullable=False, default=0),
                          Column('approval', Integer, nullable=False, default=0),
                          Column('decline', Integer, nullable=False, default=0),
                          Column('created_at', DateTime(timezone=False)),
                          Column('updated_at', DateTime(timezone=False)),
                          Column('deleted_at', DateTime(timezone=False)),
                          Column('deleted', Boolean(create_constraint=True, name=None))
                          )
table_list.append(application_table)
